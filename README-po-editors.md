...
Note that this file is subject to frequent changes, and may contain terms that will later permanently deleted from the ontology, (rather than made obsolete). Users should use this file with caution. 
...
See: https://github.com/Planteome/plant-ontology/wiki/PO-Numberspaces
